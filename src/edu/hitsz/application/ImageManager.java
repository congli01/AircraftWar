...
public class ImageManager {
    ...
    public static BufferedImage COMMON_ENEMY_IMAGE;
    ...
    static {
        try {
            ...
            COMMON_ENEMY_IMAGE = ImageIO.read(new FileInputStream("src/images/mob.png"));
            ...
            CLASSNAME_IMAGE_MAP.put(CommonEnemy.class.getName(), COMMON_ENEMY_IMAGE);
